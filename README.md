...
flowchart LR
  ...
  S --> D["Reached-step Reaction Diff"]
...
- Reaction Diff: a responsive, read-only before/after comparison with highlighted structures, exact bond and atom-property deltas, performed arrows, and undo-aware reachability.
...
- Fourteen top-level imperative WebMCP tools backed by the same store as the human interface.
